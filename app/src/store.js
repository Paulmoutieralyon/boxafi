...
export default class Store {
 ...
 // store the user un the localstorage when you login
        let user = null;
...
// Add user selected to the member
...
// create a new channel down the others
        const channelId = _.get(channel, '_id');
    ...
    addMessage(id, message = {}) {
        // create message
        // know who is author of the message
